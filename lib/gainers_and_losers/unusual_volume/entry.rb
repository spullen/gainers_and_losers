module GainersAndLosers
  module UnusualVolume
    class Entry
      ...
      attr_reader :symbol, :name, :price, :last_trade_time, :direction, :price_change, :price_change_percentage, :volume_change_percentage
      
      def initialize(symbol, name, price, last_trade_time, direction, price_change, price_change_percentage, volume_change_percentage)
        @symbol                   = symbol
        @name                     = name
        @price                    = price.to_f
        ...
        @volume_change_percentage = parse_volume_percentage(volume_change_percentage)
      end
      ...
      def ==(other)
        (self.symbol                    == other.symbol                  &&
         ...
         self.volume_change_percentage  == other.volume_change_percentage)
      end
      ...
      private
        ...
        def parse_volume_percentage(volume)
          volume.gsub(',', '').gsub('%', '').to_i
        end
