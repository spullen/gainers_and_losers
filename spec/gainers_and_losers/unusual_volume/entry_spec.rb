...
describe GainersAndLosers::UnusualVolume::Entry do
  let!(:now)          { Time.now }
  let!(:current_time) { Time.local(now.year, now.month, now.day, 20, 0, 0) }

  before(:each) do
    @entry = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '320%')
  end
  ...
  describe '#price_change' do
    ...
    context 'given a negative value' do
      before(:each) do
        @entry = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Down', '0.08', '0.31%', '320%')
      end
  ...
  describe '#volume_change_percentage' do
    it 'returns the volume change percentage' do
      @entry.volume_change_percentage.should == 320
    end
  end
  ...
  describe '#==' do
    context 'given identical entries' do
      before(:each) do
        @entry1 = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '320%')
        @entry2 = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '320%')
      end
    ...
    context 'given two different entries' do
      before(:each) do
        @entry1 = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '320%')
        @entry2 = GainersAndLosers::UnusualVolume::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Down', '0.08', '0.31%', '325%')
      end
