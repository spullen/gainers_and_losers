...
describe GainersAndLosers::MarketMovers::Entry do
  let!(:now)          { Time.now }
  let!(:current_time) { Time.local(now.year, now.month, now.day, 20, 0, 0) }

  before(:each) do
    @entry = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '41,395,585')
  end
  ...
  describe '#price_change' do
    ...
    context 'given a negative value' do
      before(:each) do
        @entry = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Down', '0.08', '0.31%', '41,395,585')
      end
  ...
  describe '#==' do
    context 'given identical entries' do
      before(:each) do
        @entry1 = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '41,395,585')
        @entry2 = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '41,395,585')
      end
    ...
    context 'given two different entries' do
      before(:each) do
        @entry1 = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Up', '0.08', '0.31%', '41,395,585')
        @entry2 = GainersAndLosers::MarketMovers::Entry.new('INTC', 'Intel Corporation', '26.15', '4:00PM EDT', 'Down', '0.08', '0.31%', '41,395,585')
      end
